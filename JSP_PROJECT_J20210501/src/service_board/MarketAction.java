...
public class MarketAction implements CommandProcess {

	@Override
	public String requestPro(HttpServletRequest request, HttpServletResponse response)
			throws ServletException, IOException {
		System.out.println("<MarketAction Start...>");
		...
		try {
			...
			System.out.println("MarketAction list.size() : " + list.size());
